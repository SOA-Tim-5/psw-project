...
public class TourSaleService : BaseService<TourSale>, ITourSaleService
{
    ...
    public TourSaleService(IMapper mapper, ITourSaleRepository saleRepository, ICrudRepository<Wishlist> wishlistRepository, ICrudRepository<WishlistNotification> wishlistNotificationRepository) : base(mapper)
    {
